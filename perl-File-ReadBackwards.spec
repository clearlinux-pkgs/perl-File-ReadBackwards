...
Requires: perl-File-ReadBackwards-license
Requires: perl-File-ReadBackwards-man
...
%package man
Summary: man components for the perl-File-ReadBackwards package.
Group: Default

%description man
man components for the perl-File-ReadBackwards package.
...
mkdir -p %{_topdir}/BUILD/File-ReadBackwards-1.05/deblicense/
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-File-ReadBackwards
cp deblicense/copyright %{buildroot}/usr/share/doc/perl-File-ReadBackwards/deblicense_copyright
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/File/ReadBackwards.pm

%files license
%defattr(-,root,root,-)
/usr/share/doc/perl-File-ReadBackwards/deblicense_copyright
